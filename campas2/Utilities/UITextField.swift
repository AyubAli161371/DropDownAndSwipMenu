...
extension UITextField{
    ...
    func inputWantedBlack(placeholderText: String) {
       // self.layer.borderWidth = 1
        ...
        addPaddingToTextField(leftPoints: 15, rightPoints: 15)
    }
    func inputWantedLight(placeholderText: String) {
       // self.layer.borderWidth = 1
        //self.layer.borderColor = UIColor.white.cgColor
        
        self.attributedPlaceholder = NSAttributedString(string: placeholderText,attributes: [NSAttributedString.Key.foregroundColor: UIColor.init(cgColor: #colorLiteral(red: 0.4392156863, green: 0.4392156863, blue: 0.4392156863, alpha: 1))])
        
        addPaddingToTextField(leftPoints: 15, rightPoints: 15)
    }
    func inputLogin(placeholderText: String) {
       // self.layer.borderWidth = 1
        //self.layer.borderColor = UIColor.white.cgColor
        ...
        addPaddingToTextField(leftPoints: 25, rightPoints: 20)
    }
    func inputMessage(placeholderText: String) {
       // self.layer.borderWidth = 1
        //self.layer.borderColor = UIColor.white.cgColor
    ...
    func inputCities(placeholderText: String) {
       // self.layer.borderWidth = 1
        //self.layer.borderColor = UIColor.white.cgColor
        
        self.attributedPlaceholder = NSAttributedString(string: placeholderText,attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
        
        addPaddingToTextField(leftPoints: 5, rightPoints: 20)
    }
    func inputResidential(placeholderText: String) {
       // self.layer.borderWidth = 1
        //self.layer.borderColor = UIColor.white.cgColor
    ...
    func inputAdd(placeholderText: String) {
       // self.layer.borderWidth = 1
        //self.layer.borderColor = UIColor.white.cgColor
        
        self.attributedPlaceholder = NSAttributedString(string: placeholderText,attributes: [NSAttributedString.Key.foregroundColor: UIColor.lightGray])
        
        addPaddingToTextField(leftPoints: 0, rightPoints: 20)
    }
    func inputCompany(placeholderText: String) {
       // self.layer.borderWidth = 1
        //self.layer.borderColor = UIColor.white.cgColor
    ...
    func inputSettings(placeholderText: String) {
       // self.layer.borderWidth = 1
        //self.layer.borderColor = UIColor.white.cgColor
    ...
    func setupPrimaryTexFieldd(placeholderText: String) {
       // self.layer.borderWidth = 1
        ...
        addPaddingToTextField(leftPoints: 15, rightPoints: 0)
    }
